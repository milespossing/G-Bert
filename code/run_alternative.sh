#! /bin/bash
#python run_pretraining.py --model_name GBert-pretraining-q --num_train_epochs 5 --do_train
python run_gbert.py --model_name GBert-predict-r --num_train_epochs 5 --do_train
